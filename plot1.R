...
## and plot a histogram of "Global Active Power". The data from the entire dataset is not 
## required for the histogram; and only the data of 1/2/2007 and 2/2/2007 is required.
...
## Create a histogram of the variable Global_active_power and use the appropriate arguments
## to get the color, label and title as per the figure given in the assignment
